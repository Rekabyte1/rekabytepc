...
const PERIPHERAL_SUBCATEGORIES = [
  "MOUSE",
  "KEYBOARD",
  "MOUSEPAD",
  "HEADSET",
...
export default async function ComponentesHomePage() {
  ...
  return (
    <main className="rb-container mx-auto max-w-6xl px-4 py-10 text-neutral-100">
      <h1 className="mb-6 text-2xl font-extrabold md:text-3xl">Componentes</h1>
      ...
      <section className="mb-6 rounded-2xl border border-neutral-800 bg-neutral-950/55 p-5 md:p-6">
        ...
        <h2 className="mt-2 text-xl font-extrabold text-white md:text-2xl">
          Componentes de PC para rendimiento y estabilidad
        </h2>
        <p className="mt-3 text-sm leading-relaxed text-neutral-300 md:text-base">
          En esta sección reunimos hardware real para armar o actualizar tu PC:
          procesadores, tarjetas gráficas, placas madre, RAM, almacenamiento,
          fuentes, gabinetes, ventilación y refrigeración.
        </p>
        <div className="mt-4 flex flex-wrap gap-2 text-xs">
          <Link
            href="/gaming-streaming"
            className="rounded-full border border-lime-400/30 bg-lime-400/10 px-3 py-1.5 font-bold text-lime-200 hover:bg-lime-400/15"
          >
            Ver periféricos gaming/streaming
          </Link>
          <Link
            href="/setup-gamer"
            className="rounded-full border border-neutral-700 bg-black/25 px-3 py-1.5 font-bold text-neutral-300 hover:border-lime-400/30 hover:text-lime-200"
          >
