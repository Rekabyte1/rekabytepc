...
function normalizeSpecs(specs: any): Array<[string, string]> {
...
export async function generateMetadata({ params }: PageProps) {
  ...
  if (mockProduct) {
    return {
      title: `${mockProduct.name} – RekaByte`,
      description: mockProduct.shortDesc ?? mockProduct.name,
      openGraph: {
        title: `${mockProduct.name} – RekaByte`,
        description: mockProduct.shortDesc ?? mockProduct.name,
        images: mockProduct.image ? [{ url: mockProduct.image }] : [],
      },
    };
  }
