    ...
    <main className="pb-14">
        ...
        <div className="mx-auto max-w-[1500px] rounded-3xl border border-neutral-800 bg-neutral-950/55 p-6 md:p-7">
          <div className="grid gap-4 lg:grid-cols-[0.95fr_2.05fr] lg:items-stretch">
            <div className="rounded-2xl border border-neutral-800 bg-black/25 p-5">
              ...
              <h2 className="mt-2 text-3xl font-display font-black text-white leading-tight">Desde Spawn hasta Clutch.</h2>
              ...
              {[
                ...
                >
                  ...
                  <div className="relative z-10 flex h-full items-end p-4 md:p-5">
                    <div>
                      <h3 className={`text-[30px] font-display font-black text-white leading-none md:text-[34px] ${card.textGlow}`}>{card.title}</h3>
        ...
        <div className="mx-auto max-w-[1500px] rounded-3xl border border-neutral-800 bg-neutral-950/55 p-5">
          <div className="mb-5 flex items-end justify-between gap-4">
            <div>
              ...
              <h2 className="mt-2 text-2xl font-display font-black text-white md:text-3xl">Lo más recomendado para tu setup</h2>
            </div>
            ...
            <div className="relative min-h-[260px]">
              ...
              <div className="relative z-10 flex h-full items-end justify-between gap-4 p-6">
                <div className="max-w-md">
                  ...
                  <h3 className="mt-2 text-3xl font-display font-black text-white">Streaming</h3>
            ...
            <div className="relative min-h-[260px]">
              ...
              <div className="relative z-10 flex h-full items-end justify-between gap-4 p-6">
                <div className="max-w-md">
                  ...
                  <h3 className="mt-2 text-3xl font-display font-black text-white">Componentes</h3>
                  <p className="mt-2 text-sm text-neutral-200">
      ...
      <section className="mt-9 px-4 sm:px-6">
        <div className="mx-auto max-w-[1500px] rounded-3xl border border-neutral-800 bg-neutral-950/45 p-4 md:p-5">
          <div className="mb-3">
            <p className="text-xs font-display font-extrabold uppercase tracking-[0.2em] text-neutral-500">PC Gamer</p>
          </div>
          ...
          {featuredBuilds.length > 0 ? (
            ...
            >
              ...
              <div>
                <h4 className="text-xl font-display font-black text-white">{featuredBuilds[0].name}</h4>
