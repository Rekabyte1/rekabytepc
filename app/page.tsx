        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-center">
          <div>
            ...
            <h2 className="mt-4 text-2xl font-black text-white md:text-3xl">
              Comenzamos con stock limitado, periféricos seleccionados y productos en constante evolución.
            </h2>

            <p className="mt-4 max-w-4xl text-sm leading-7 text-neutral-300 md:text-base">
              En RekaByte priorizamos una selección cuidada de teclados gamer, periféricos y productos para setup,
              buscando siempre un equilibrio entre estética, calidad y experiencia de uso. En esta etapa, publicamos
              solo lo que realmente podemos respaldar, priorizando confianza, atención cercana y una experiencia de
              compra clara. Además, también iremos incorporando equipos armados y productos seleccionados para quienes
              buscan una solución más completa.
            </p>
          ...
          <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-1">
            <div className="rounded-2xl border border-neutral-800 bg-black/20 p-4">
              <div className="text-sm font-black text-white">Selección cuidada</div>
              <div className="mt-1 text-xs leading-5 text-neutral-400">
                Productos elegidos por calidad, estética y buena experiencia de uso.
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-neutral-800 bg-black/20 p-4">
              <div className="text-sm font-black text-white">Lanzamiento en etapa inicial</div>
              <div className="mt-1 text-xs leading-5 text-neutral-400">
                Si detectas algún detalle o inconveniente, agradeceremos tu aviso para mejorarlo lo antes posible.
              </div>
            </div>
